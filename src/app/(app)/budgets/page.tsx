...
export default async function BudgetsPage() {
  ...
  // rows SURVIVE; `handoverKeys` names the days it deliberately lets BOTH sides
  // through (DECISIONS #454), which is the one place this page's figures can
  // count a charge more than once. U.31: fetched from ONE read of the link
  // table (`getReconciliationBoundary`) rather than two sequential calls each
  // independently re-reading it — the two could otherwise desync if an
  // Undo-combine landed between them.
