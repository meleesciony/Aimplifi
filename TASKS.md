...
| 1.7 | Personalized triage alternatives: `suggestAlternatives` consults the user's Correction history before the generic list. Pure function change + tests. | Opus 4.8 | medium | 40k | [x] done 2026-07-10 (#206). `deriveCorrectionHints` + triage wiring; golden empty history unchanged. |
