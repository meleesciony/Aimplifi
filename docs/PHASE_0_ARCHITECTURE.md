...
- Minimum-path interest: average daily balance method, APR/365, compounded monthly at
  ...
  share one definition). **[As built: shipped via DECISIONS #29 — average-daily-balance
  method (APR÷365 × the cycle's average balance, grace-gated), which the v1 simple-monthly
  approximation (#5/#21) deferred. Matches this original §4 intent.]**
