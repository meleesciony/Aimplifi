...
> Entries #1-#401 were moved verbatim to
> `docs/archive/DECISIONS_ARCHIVE_1_to_401.md` on 2026-08-27 to keep this file loadable.
> Only entries #402 onward live here; append new entries as before — the numbering
> never resets, the archive holds the lower numbers.
