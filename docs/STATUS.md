...
**CI (run id on sha):** pending read after push — `scripts/ci-status.sh`.
**Live:** pending marker check after deploy — `recurring-charges-toggle` on https://www.aimplifi.app/recurring.
