...
| **C3** | **Confounding compounding / time in market / opportunity cost** | Housel, Sethi, Collins | Time does the work; small recurring leaks are decades of future wealth | **Present** — `opportunityFVCents` 10/20/30yr FV; lead with 30yr |
