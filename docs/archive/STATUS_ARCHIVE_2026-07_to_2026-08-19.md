...
> HISTORICAL
> BUILT/record sections rotated verbatim from docs/STATUS.md on 2026-09-11
> (ledger-ceiling rotation). OPEN/FOUND/DECIDED items and the newest BUILT
> entries stay in the live file.
