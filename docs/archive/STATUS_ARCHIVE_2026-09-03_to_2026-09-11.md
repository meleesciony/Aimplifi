# STATUS archive — BUILT entries 2026-09-03 through 2026-09-11

> HISTORICAL
> Rotated verbatim from `docs/STATUS.md` on 2026-09-17 (ledger ceiling): the BUILT entries for
> DECISIONS #637, #638, #724, #725, #734, #735 and #736. Live counts in these entries are
> historical; the current counts live only in the newest BUILT entry of `docs/STATUS.md`.
