> **HISTORICAL** — archived 2026-08-28 from `PROGRESS.md` (verbatim moves, not rewrites).
> Point-in-time session log; do not update. Current-wave sessions (2026-08-20 onward)
> remain in `PROGRESS.md`.

# PROGRESS archive — 2026-08-01 through 2026-08-17
