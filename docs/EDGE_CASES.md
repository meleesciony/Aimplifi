...
falls through (eventually to investing). Employer match and tax-advantaged room are
not on file this slice (`unknown` → skipped). CREDIT is revolving only when a
