...
describe('merchant-group triage (Phase 3b)', () => {
  ...
  it('pure grouping: leverage sort (count desc), preserved newest-first rows, merchantless fallback key', () => {
    const groups = groupReviewRows([
      { id: 'a1', merchantId: null, merchantCanonical: 'Local One', rawDescriptor: 'LOCAL ONE', amountCents: -100, date: '2026-06-09', accountId: 'acct', accountName: 'X', status: 'POSTED', reimbursement: null, aggregate: false, suggestedCategoryId: null, providerCategoryId: null },
      { id: 'b1', merchantId: 'm1', merchantCanonical: 'Busy', rawDescriptor: 'BUSY 1', amountCents: -100, date: '2026-06-08', accountId: 'acct', accountName: 'X', status: 'POSTED', reimbursement: null, aggregate: false, suggestedCategoryId: 'coffee', providerCategoryId: null },
      { id: 'b2', merchantId: 'm1', merchantCanonical: 'Busy', rawDescriptor: 'BUSY 2', amountCents: -200, date: '2026-06-07', accountId: 'acct', accountName: 'X', status: 'POSTED', reimbursement: null, aggregate: false, suggestedCategoryId: 'dining', providerCategoryId: null },
    ]);
