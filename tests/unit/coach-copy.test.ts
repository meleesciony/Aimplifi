...
const ALL_STRINGS: { label: string; text: string; isProjection: boolean }[] = [
  ...
  { label: 'memoryDividend', text: COACH_COPY.memoryDividend(), isProjection: false },
  { label: 'memoryDividendEmpty', text: COACH_COPY.memoryDividendEmpty(), isProjection: false },
  { label: 'memoryDividendNotApplicable', text: COACH_COPY.memoryDividendNotApplicable(), isProjection: false },
