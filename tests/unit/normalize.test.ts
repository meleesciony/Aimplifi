...
const FIXTURE: [string, string, string][] = [
  ...
  ['GEICO *AUTO 800-841-3000', 'Geico', 'auto-insurance'],
  ['COMCAST / XFINITY 800-COMCAST', 'Xfinity', 'internet'],
  ...
  ['CHICK-FIL-A #02034', 'Chick-fil-A', 'fast-food'],
  ["MCDONALD'S F13339", "McDonald's", 'fast-food'],
  ['STARBUCKS 800-782-7282', 'Starbucks', 'coffee'],
  ...
  ['DELTA AIR 0062341022334', 'Delta Air Lines', 'air-travel'], // #163: airline = air-travel leaf
  ['MARRIOTT ATLANTA MARQ', 'Marriott', 'travel'],
  ['AIRBNB * HM8Q2X PAYMENTS', 'Airbnb', 'travel'],
  ['CVS/PHARM 04733--1100 P', 'CVS Pharmacy', 'pharmacy'],
  ['WALGREENS #6332', 'Walgreens', 'pharmacy'],
  ['HOME DEPOT #0121', 'Home Depot', 'home-improvement'],
  ['LOWES #02748*', "Lowe's", 'home-improvement'],
